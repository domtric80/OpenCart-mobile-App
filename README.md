...
<p align="center">
  ...
  <a href="https://github.com"><img src="https://img.shields.io/badge/Version-v1.1.0-brightgreen?style=for-the-badge" alt="Version" /></a>
</p>
...
| :--- | :--- | :--- | :--- | :--- |
| **v1.1.0** (Latest) | [`CartAdmin-v1.1.0.apk`](../../releases/tag/v1.1.0) | Android 7.0 (API 24) o sup. | `arm64-v8a`, `armeabi-v7a`, `x86_64`, `x86` | 🟢 Stabile |
