...
Estensione HTTPS tra CartAdmin Android e OpenCart 4.1.x, sviluppata da OpenCart ITALIA by SOLOSOLUZIONI. Questo sorgente corrisponde alla release stabile `2.1.5` e deve essere usato con l'app della stessa versione.
