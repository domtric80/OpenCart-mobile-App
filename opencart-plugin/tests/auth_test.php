...
assertSameValue('2.1.1-dev.1', $manifest['version'] ?? '', 'The OpenCart manifest version must match the development build.');
assertSourceContains($bridgeSource, "'bridge_version' => '2.1.1-dev.1'", 'The status endpoint must report the same development build.');
