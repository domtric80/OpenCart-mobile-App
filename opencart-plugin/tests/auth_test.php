...
assertSameValue('2.1.6', $manifest['version'] ?? '', 'The OpenCart manifest version must match the stable build.');
assertSourceContains($bridgeSource, "'bridge_version' => '2.1.6'", 'The status endpoint must report the same stable build.');
